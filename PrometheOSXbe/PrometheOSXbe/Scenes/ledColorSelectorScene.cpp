...
void ledColorSelectorScene::render()
{
	...
	drawing::drawBitmapStringAligned(context::getBitmapFontMedium(), "Please select a LED Color...", theme::getTitleTextColor(), theme::getHeaderAlign(), 40, theme::getHeaderY(), 640);
