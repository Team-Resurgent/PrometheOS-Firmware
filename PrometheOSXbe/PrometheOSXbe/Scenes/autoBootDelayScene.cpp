...
void autoBootDelayScene::render()
{
	...
	drawing::drawBitmapStringAligned(context::getBitmapFontMedium(), "Auto Boot Delay option...", theme::getHeaderTextColor(), theme::getHeaderAlign(), 40, theme::getHeaderY(), 640);
