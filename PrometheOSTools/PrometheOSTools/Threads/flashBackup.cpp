...
uint64_t WINAPI flashBackup::process(void* param) 
{
	...
	{
		filePath = fileSystem::combinePath("E:\\PrometheOS\\Backup", "PrometheOS-Xenium.bin");
	}
	else if (context::getModchipType() == modchipTypeXecuter)
	{
		filePath = fileSystem::combinePath("E:\\PrometheOS\\Backup", "PrometheOS-Xecuter.bin");
	}
	else if (context::getModchipType() == modchipTypeAladdin1mb)
	{
		filePath = fileSystem::combinePath("E:\\PrometheOS\\Backup", "PrometheOS-Aladdin1mb.bin");
	}
	else if (context::getModchipType() == modchipTypeAladdin2mb)
	{
		filePath = fileSystem::combinePath("E:\\PrometheOS\\Backup", "PrometheOS-Aladdin2mb.bin");
	}
	else if (context::getModchipType() == modchipTypeXchanger)
	{
		filePath = fileSystem::combinePath("E:\\PrometheOS\\Backup", "PrometheOS-Xchanger.bin");
	}
	else
	{
